...
const TABS = [
  ...
  { key: 'highlights' as const, label: 'Highlights', icon: ListChecks },
  { key: 'relacionados' as const, label: 'Relacionados', icon: ArrowLeftRight },
  { key: 'compara' as const, label: 'Compara', icon: GitCompare },
];
                      ...
                      <tr key={p.id} className="border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-center gap-1">
                            <button onClick={() => openEditor(p)} className="p-1.5 rounded-lg text-[#C8FF00] hover:bg-[#C8FF00]/10" title="Editar"><Edit2 className="w-4 h-4" /></button>
                            ...
                            <button onClick={() => openDetail(p)} className="p-1.5 rounded-lg text-blue-600 hover:bg-blue-50" title="Detalle"><ArrowRight className="w-4 h-4" /></button>
                          </div>
                        </td>
                      </tr>
                    );
              ...
              return (
                <div key={p.id} className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
                  ...
                  <div className="flex justify-end gap-2 pt-2 border-t border-gray-100">
                    <button onClick={() => openEditor(p)} className="p-2 rounded-lg text-[#C8FF00] hover:bg-[#C8FF00]/10" title="Editar"><Edit2 className="w-4 h-4" /></button>
