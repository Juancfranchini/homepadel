  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
      ...
      <div>
        ...
        <div className="relative"><Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#8A8A85]" /><input {...register('password')} type={showPassword ? 'text' : 'password'} autoComplete="off" placeholder="********" className={errors.password ? errorInputClass : inputClass} />
